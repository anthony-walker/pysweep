...
batch = """#!/bin/tcsh
    ...
    date
    echo ' '
    jsrun -n{:d} -r1 -a40 -c40 -g4 pysweep -f euler -nx {:d} -nt 2000 -b 16 -s 1 --swept --verbose --ignore --clean

    jsrun -n{:d} -r1 -a40 -c40 -g4 pysweep -f euler -nx {:d} -nt 2000 -b 16 -s 1 --verbose --ignore --clean

    jsrun -n{:d} -r1 -a40 -c40 -g4 pysweep -f heat -nx {:d} -nt 2000 -b 16 -s 1 --swept --verbose --ignore --clean

    jsrun -n{:d} -r1 -a40 -c40 -g4 pysweep -f heat -nx {:d} -nt 2000 -b 16 -s 1 --verbose --ignore --clean

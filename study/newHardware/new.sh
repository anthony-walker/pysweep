...
do
        mpiexec -n 32 --hostfile ./new-nodes pysweep -f $PYSWEEP_EQN -nx $nx -nt 500 -b $PYSWEEP_BLOCK -s $PYSWEEP_SHARE --swept --verbose --ignore --clean

        mpiexec -n 32 --hostfile ./new-nodes pysweep -f $PYSWEEP_EQN -nx $nx -nt 500 -b $PYSWEEP_BLOCK -s $PYSWEEP_SHARE --verbose --ignore --clean
done
